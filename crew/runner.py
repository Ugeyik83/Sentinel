...
class SimulationRunner:
    ...
    def run(self, scenario: dict) -> dict:
        ...
        manager = (
            self.agents.get("managing_director")
        ...
        output = {
            ...
            # Rapor için özet — debate judge kararı ön plana
            "final_decision": debate_result.get(
                "debate_summary", {}
            ).get("judge_decision", crew_result_str),
        }
        ...
        logger.info(f"Simülasyon + Debate tamamlandı: {scenario['name']}")
        return output
